...
public class SDCClient {
    ...
    private SdcClientConfig sdcClientConfig;
    ...
    public ProductInstanceService getProductInstanceService(String baseUrl, String mediaType) {
        ...
        return new ProductInstanceServiceImpl(sdcClientConfig, baseUrl, mediaType);
    }
    ...
    public TaskService getTaskService(String baseUrl, String mediaType) {
        return new TaskServiceImpl(sdcClientConfig, baseUrl, mediaType);
    }
    ...
    public TaskService getTaskService(String baseUrl, String mediaType, Long maxWaiting, Long waitingPeriod) {
        return new TaskServiceImpl(sdcClientConfig, baseUrl, mediaType, waitingPeriod, maxWaiting);
    }
    ...
    public ProductService getProductService(String baseUrl, String mediaType) {
        return new ProductServiceImpl(sdcClientConfig, baseUrl, mediaType);
    }
    ...
    public ProductReleaseService getProductReleaseService(String baseUrl, String mediaType) {
        return new ProductReleaseServiceImpl(sdcClientConfig, baseUrl, mediaType);
    }
    ...
    public ChefNodeService getChefNodeService(String baseUrl, String mediaType) {
        return new ChefNodeServiceImpl(sdcClientConfig, baseUrl, mediaType);
    }
    ...
    public ChefClientService getChefClientService(String baseUrl, String mediaType) {
        return new ChefClientServiceImpl(sdcClientConfig, baseUrl, mediaType);
    }

    public SdcClientConfig getSdcClientConfig() {
        return sdcClientConfig;
    }

    public void setSdcClientConfig(SdcClientConfig sdcClientConfig) {
        this.sdcClientConfig = sdcClientConfig;
    }
}

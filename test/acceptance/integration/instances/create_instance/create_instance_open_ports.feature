# -*- coding: utf-8 -*-
Feature: Deploy products in an instance with open_ports and open_ports_udp metadata values
    ...
    Scenario Outline: Create and launch a Blueprint with one product with open_ports and open_ports_udp metadatas
        ...
        | envqamet2   | instqamet2   | testing_metadata_03 | testing_metadata_03=0.0.1 | 40-1080 33     | 135-2556 33 |
